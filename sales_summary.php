    ...
    <section class="content">
        ...
        <div class="col-xs-10">
            ...
            <table class="col-xs-10">
                ...
                <td> <button type="submit" class="btn btn-primary pull-right">Filter</button></td>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header" align="right">
                <a href="pdf_sales_summary.php?from=<?php echo $from;?>&to=<?php echo $to;?>" target="_blank" class="success"><i class='glyphicon glyphicon-print'></i>&nbsp;Print PDF</a>
            </div>
