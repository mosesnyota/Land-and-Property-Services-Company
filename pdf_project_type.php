...
//Page header
    function Header() {
        ...
        $this->Cell(195, 6, "Project Type" , 0, 0, "C", 0);
...
$pdf->Cell(10, 7, "#", 1, 0, "L", 1);
       $pdf->Cell(160, 7, "Types of Projects", 1, 0, "L", 1);
...
$statement = "SELECT `project_type_id`,`project_type` FROM `project_types`";
...
while ($row = $result->fetch_assoc()) {
    ...
    $pdf->Cell(10, 7, $num, 1, 0, "L", 1);
       ...
       $pdf->Cell(160, 7, $row['project_type'], 1, 0, "L", 1);
    ...
    if ($y > 275) {
       ...
       $pdf->Cell(10, 7, "#", 1, 0, "L", 1);
       $pdf->Cell(160, 7, "Types of Projects", 1, 0, "C", 1);
