        ...
        <div class="col-xs-12">
          ...
          <div class="box-footer clearfix no-border">
           ...
           include('dao/connect.php');
            $statement = "SELECT `company_name`,`contact_person`, invoice.*, DATE_FORMAT(invoice.`invoice_date`,'%d-%m-%Y') AS sdate FROM invoice JOIN `suppliers` ON invoice.`supplier_id` = suppliers.`supplier_id` ORDER BY pay_status desc, `invoice_date` DESC ";
           ...
           ?>    
               <tr>
                  ...
                  <td> <?php echo strtoupper($row['contact_person']); ?></td>
                  <td> <?php echo $row['sdate']; ?></td>
                  <td> <?php echo $row['amount']; ?></td>
                  <td> <?php echo $row['paid_amount']; ?></td>
                  <td> <?php echo $row['amount'] - $row['paid_amount']; ?></td>
                  <?php if($row['pay_status'] == 'Unpaid') { ?>
                  <td><a href="pay_invoice.php?id=<?php echo $row['invoice_id'] ?>" title="Click to Edit"><i  <button type="button" class="btn btn-danger btn-sm"><b class="fa fa-plus-circle" ></b> Pay </button></a></td>
                  <td><a href="pdf_single_purchase_invoice.php?invoice_id=<?php echo $row['invoice_id']; ?>" target="_blank"><i  <button type="button" class="btn btn-warning btn-sm"><b class="fa fa-file-pdf-o" ></b> View </button></a></td>
                      <?php } else{ ?>
