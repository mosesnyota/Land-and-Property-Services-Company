...
$pdf->Cell(10, 7, "#", 1, 0, "L", 1);
       ...
       $pdf->Cell(35, 7, "Product", 1, 0, "C", 1);
       $pdf->Cell(25, 7, "Sale Price", 1, 0, "C", 1);
       $pdf->Cell(30, 7, "Price Type", 1, 0, "C", 1);
...
GROUP BY category, product_value, pricetype
...
while ($row = $result->fetch_assoc()) {
    ...
    $pdf->Cell(35, 7, $row['product_value'], 1, 0, "L", $fill);
    $pdf->Cell(25, 7, $row['price'], 1, 0, "R", $fill);
    $pdf->Cell(30, 7, $row['pricetype'], 1, 0, "L", $fill);
...
$pdf->Cell(140, 7, "Totals", 1, 0, "C", 1);
$pdf->Cell(15, 7, $totalUnits, 1, 0, "C", 1);
$pdf->Cell(25, 7, number_format($totalSale,2), 1, 0, "R", 1);
