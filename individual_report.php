        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header" align="right">
                <a href="pdf_individuals.php?from=<?php echo $from;?>&to=<?php echo $to;?>" target="_blank" class="success"><i class='glyphicon glyphicon-print'></i>&nbsp;Print PDF</a>
            </div>
...
GROUP BY `customer`.`cust_id` ORDER BY balance DESC";
           ...
           ?>    
               <tr>
                  <td> <?php echo $num; ?></td>
                  <td><b> <?php echo $row['fname']." ".$row['mname']; ?> </b></td>
                  <td><b> <?php echo $row['total']; ?></b></td>
                  <td><b> <?php echo $row['paid']; ?></b></td>
                  <td><b> <?php echo $row['balance']; ?></b></td>
                  
                  <td><a href="pdf_myreport.php?id=<?php echo $row['cust_id'] ?>&from=<?php echo $from;?>&to=<?php echo $to;?>" target="_blank" title="Click View Report"><i  <button type="button" class="btn btn-info btn-sm"><b class="fa fa-file-pdf-o" ></b> View Report</button></a></td>
