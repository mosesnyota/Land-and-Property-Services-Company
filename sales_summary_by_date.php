  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Sales Summary By Date Report</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header" align="right">
                <a href="pdf_sales_summary_date.php?from=<?php echo $from;?>&to=<?php echo $to;?>" target="_blank" class="success"><i class='glyphicon glyphicon-print'></i>&nbsp;Print PDF</a>
            </div>
           ...
           ?>    
               <tr>
                  <td> <?php echo $num; ?></td>
                  <td><b> <?php echo $row['sdate3']; ?> </b></td>
                  <td><b> <?php echo number_format($row['total'],2); ?></b></td>
                  <td> <b><?php echo number_format($row['paid'],2); ?></b></td>
