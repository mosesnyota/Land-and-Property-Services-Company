  ...
  <div class="content-wrapper">
      ...
      <div class="row">
        <div class="col-md-10">
          <div class="box box-primary">
              ...
              <form role="form" action="save_invoice.php" method="post"  enctype="multipart/form-data">
              <div class="box-body"> 
    ...
    ?>
               ...
               <div class="form-group">
                  <label for="totalretail">Total Cost of Goods:</label>
                  <input name="totalretail" type="text" class="form-control" id="totalretail"   disabled="true" value="<?php  echo $totalpurchase; ?>">
               </div>
        ...
        $result = $db->query("SELECT * FROM `suppliers` ORDER BY `company_name` ASC, `contact_person` ASC");
        while ($de = $result->fetch_assoc()) {
            $catid = $de['supplier_id'];
            $cat = strtoupper($de['company_name']." ".$de['contact_person']);?>  
