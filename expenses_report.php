        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header" align="right">
                <a href="pdf_expenses.php?from=<?php echo $from;?>&to=<?php echo $to;?>" target="_blank" class="success"><i class='glyphicon glyphicon-print'></i>&nbsp;Print PDF</a>
            </div>
           ...
           include('dao/connect.php');
            $statement = "SELECT expenses.*, `expense_types`.`expense_type` FROM expenses JOIN `expense_types` ON `expenses`.`expense_type` = `expense_types`.`expense_type_id` "
                    . " WHERE  expense_date >= '$from' AND expense_date <= '$to' order by expense_date desc";
